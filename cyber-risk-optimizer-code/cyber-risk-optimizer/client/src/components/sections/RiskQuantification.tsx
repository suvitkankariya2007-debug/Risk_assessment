        ...
        <div className="terminal-card asset-register stagger-enter stagger-2">
          ...
          <table className="data-table compact-table">
            ...
            <tbody>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={6} style={{ textAlign: "center", padding: "28px 0", color: "#687483" }}>No assets match this filter.</td></tr>
              )}
            </tbody>
          </table>
        </div>
          ...
          <div className="asset-summary-footer">
            ...
            <div style={{ display: "flex", gap: 20, marginTop: 16 }}>
              ...
              <div>
                ...
                <div style={{ marginTop: 6, color: "#dce3e9", fontSize: 12 }}>{selected.bu}</div>
              </div>
            </div>
          </div>
        </div>
